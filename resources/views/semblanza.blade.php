...
@section('content')
    <div class="content">
        ...
        <div class="row" style="align-items: center">
            ...
            <div class = "col-sm-6" style="background-color: #f5f5ff; text-align: center;">
                <br>
                <p2>Obras</p2>
                <p>Augusto Mijares fue considerado como uno de los</p>
                <p>ensayistas más destacados del siglo XXI. Esta ha sido su obra:</p>
                <ol style="display:inline;">
                    <p>1.La patria de los venezolanos (1750)</p>
                    <p></p>
                    <p>2.La interpretación pesimista de la sociología hispanoamericana(1938)</p>
                    <p></p>
                    <p>3.Hombres e ideas de América (1940)</p>
                    <p></p>
                    <p>4.Educación (1943)</p>
                    <p></p>
                    <p>5.La luz y el espejo (1955)</p>
                    <p></p>
                    <p>6.La ideología de revolución emancipadora (1961)</p>
                    <p></p>
                    <p>7.Lo afirmativo venezolano (1963)</p>
                    <p></p>
                    <p>8.El Libertador ( 1964)</p>
                    <p></p>
                    <p>9.La evolución política de Venezuela (1967)</p>
                    <p></p>
                    <p>10.Longitud y latitud (1971)</p>
                    <p></p>
                </ol>
            </div>
        </div>
