        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form method="POST" id="registerForm">
                    ...
                    <div class="form-group row">
                        <label for="addressInput" class="col-md-4 col-form-label text-md-right">{{ __('Address') }}</label>

                        <div class="col-md-6">
                            <input id="addressInput" type="text" class="form-control" name="address" value="{{ old('address') }}"  autocomplete="address" autofocus>
                        </div>
                    </div>
